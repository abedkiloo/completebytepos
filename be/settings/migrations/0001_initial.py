...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='tenant',
            index=models.Index(fields=['code'], name='settings_te_code_d7527b_idx'),
        ),
        migrations.AddIndex(
            model_name='tenant',
            index=models.Index(fields=['name'], name='settings_te_name_08b3da_idx'),
        ),
        migrations.AddIndex(
            model_name='tenant',
            index=models.Index(fields=['is_active'], name='settings_te_is_acti_a25f30_idx'),
        ),
        ...
        migrations.AddIndex(
            model_name='branch',
            index=models.Index(fields=['tenant', 'branch_code'], name='settings_br_tenant__106b6a_idx'),
        ),
        migrations.AddIndex(
            model_name='branch',
            index=models.Index(fields=['tenant', 'name'], name='settings_br_tenant__dd3141_idx'),
        ),
        migrations.AddIndex(
            model_name='branch',
            index=models.Index(fields=['is_active'], name='settings_br_is_acti_349c78_idx'),
        ),
        migrations.AddIndex(
            model_name='branch',
            index=models.Index(fields=['is_headquarters'], name='settings_br_is_head_6bf409_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='branch',
