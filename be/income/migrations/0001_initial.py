    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['income_date'], name='income_inco_income__3ca912_idx'), models.Index(fields=['status'], name='income_inco_status_522861_idx'), models.Index(fields=['category', 'income_date'], name='income_inco_categor_fa8ea0_idx')],
            },
        ),
    ]
