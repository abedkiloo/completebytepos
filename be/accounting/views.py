...
# These functions are kept here for any legacy code that imports from views
# All new code should import directly from accounting.services
def create_expense_journal_entry(expense):
    """Create journal entries for an expense - delegates to service layer"""
    from .services import create_expense_journal_entry as service_func
    return service_func(expense)


def create_income_journal_entry(income):
    """Create journal entries for an income - delegates to service layer"""
    from .services import create_income_journal_entry as service_func
    return service_func(income)


def create_sale_journal_entry(sale):
    """Create journal entries for a sale - delegates to service layer"""
    from .services import create_sale_journal_entry as service_func
    return service_func(sale)
