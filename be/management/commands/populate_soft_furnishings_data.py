...
Generates: Products, Customers, Sales (with installments), Expenses
"""
...
class Command(BaseCommand):
    help = 'Generate comprehensive soft furnishings data: products, customers, sales, installments, expenses'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS('GENERATING SOFT FURNISHINGS DATA'))
        self.stdout.write(self.style.SUCCESS('=' * 70))
        ...
        products = self.create_products(options['products'], superuser, branch)
        
        # Step 2: Create customers
        self.stdout.write('\n2. Creating customers...')
        customers = self.create_customers(options['customers'], superuser, branch)
        
        # Step 3: Create sales with different payment statuses
        self.stdout.write('\n3. Creating sales with various payment statuses...')
        sales_data = self.create_sales(options['sales'], products, customers, superuser, branch)
    ...
    def create_products(self, count, superuser, branch):
